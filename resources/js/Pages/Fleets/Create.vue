...
function submit() {
    ...
    })).post('/flotillas', { forceFormData: true });
}
                    ...
                    <div class="mt-3 grid gap-4 lg:grid-cols-2">
                        <div>
                            ...
                            >
                                ...
                                <span class="text-[0.7rem] text-slate-400 dark:text-brand-gray/70">PDF, imágenes u Office · hasta 10 archivos de 10 MB</span>
                            </button>
